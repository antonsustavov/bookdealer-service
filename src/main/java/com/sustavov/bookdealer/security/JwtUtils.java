...
public class JwtUtils {
    @Value("${bookdealer.jwt.jwtSecret}")
    private String jwtSecret;
    @Value("${bookdealer.jwt.jwtExpirationMs}")
    private int jwtExpirationMs;
    @Value("${bookdealer.jwt.jwtCookieName}")
    ...
    public ResponseCookie generateJwtCookie(UserDetailsDefault userPrincipal) {
